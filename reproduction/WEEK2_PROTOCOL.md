...
- Use all 800 official 32x32 training maps by default and 50 epochs as the first intermediate milestone. The paper-scale 200-epoch run remains the final target.
